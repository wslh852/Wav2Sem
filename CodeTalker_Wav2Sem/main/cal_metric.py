...
def main():
    ...
    # parser.add_argument("--pred_path", type=str, default="/home/china/zxwork/CodeTalker-main/RUN/BIWI/CodeTalker_s2/result_metric1/npy/")
    parser.add_argument("--pred_path", type=str, default="/home/lh/lihao/codetalker/CodeTalker-main/save_data/npy")
    parser.add_argument("--gt_path", type=str, default="/home/lh/lihao/codetalker/CodeTalker-main/vocaset/vertices_npy")
    parser.add_argument("--region_path", type=str, default="/home/china/zxwork/CodeTalker-main/BIWI/regions/")
    parser.add_argument("--templates_path", type=str, default="/home/lh/lihao/codetalker/CodeTalker-main/vocaset/templates.pkl")
    ...
    for subject in train_subject_list:
        for sentence in sentence_list:
            ...
            vertices_pred = vertices_pred[:vertices_gt.shape[0],:,:] # mesh

            #todo gt对齐pred shape GT长度不一定比预测的短，可能比预测的长
            vertices_gt=vertices_gt[:vertices_pred.shape[0],:,:]
            # vertices_gt=vertices_gt[:vertices_gt.shape[0],:,:]
            a=templates[subject].reshape(1,23370,3)
