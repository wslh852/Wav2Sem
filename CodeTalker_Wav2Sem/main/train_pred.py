...
import cv2
import sys
sys.path.append('/home/lh/lihao/wav2bertcvpr2024/codetalker_wav2bert/CodeTalker-main')
...
def main():
    args = get_parser('/home/lh/lihao/wav2bertcvpr2024/wav2bert/CodeTalker_Wav2Sem/config/vocaset/stage2.yaml')
...
def train(train_loader, model, loss_fn, optimizer, epoch, cfg):
    ...
    for i, (audio, data, template, one_hot, filename, text) in enumerate(train_loader):
        # pdb.set_trace()
        ####################
        ...
        loss, loss_detail = model(audio, template, data, one_hot, text, criterion=loss_fn, use_wav2sem=cfg.Wav2Sem)
